...
# ============================ ENGINE (same classes as your notebook) ============================
...
# ============================ STREAMLIT UI ============================
st.set_page_config(page_title="Blinkit Simulator", page_icon="\U0001f6d2", layout="wide")

@st.cache_resource
def build_sim(_df):
    return BlinkitSimulator(_df)

st.title("\U0001f6d2 Blinkit Quick-Commerce Simulator")
st.caption("Pull a lever, watch the outcome change. Powered by an OOP engine + ML models.")

uploaded = st.file_uploader("\U0001f4c1 Upload your dataset (CSV)", type="csv")
if uploaded is None:
    st.info("\U0001f446 Upload your Blinkit CSV above to start the simulator.")
    st.stop()
...
tab1, tab2, tab3, tab4 = st.tabs(["\U0001f4b0 Pricing", "\U0001f69a Delivery", "\U0001f4c8 Sales", "\U0001f9e9 Segments"])
